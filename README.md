...
## Overview
### Description
PioneerHub is a social platform that connects the CSUEB community together. PioneerHub is your go-to for reaching out to not only your classmates but also your department peers. Features include feed that displays student post, a hub that gathers different resouces on campus on one screen, displaying and editing users profile, and a simple map that drops down locations of the buildings on campus. PioneerHub is here to provide a sense of community and unity to the CSUEB family. https://www.youtube.com/watch?v=eJFV6IWQ3EY
...
### Sprint 3
* [X] implemented like functionality to user post
* [X] separated user class from post and expanded the server functionality
* [X] The profile fragment now displays current users information
* [X] The profile fragment displays filtered posts that belongs to the individual user
* [X] Implemented a resources fragment that has tiles that redirects user to information
* [X] Created more project issues for next sprint

### Images from sprint 3
